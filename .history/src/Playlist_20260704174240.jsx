...
const songs = [
  { n: '01', title: 'Golden Hour',       artist: 'JVKE',                id: '5odlY52u43F5BjByhxg7wg' },
  { n: '02', title: 'Die For You',       artist: 'The Weeknd',          id: '2LBqCSwhJGcFQeTHMVGwy3' },
  { n: '03', title: 'Essence',           artist: 'Wizkid ft. Tems',     id: '6nzxy2wXs6tLgzEtqOkEi2' },
  { n: '04', title: "Creepin'",          artist: 'Metro Boomin',        id: '2dHHgzDwk4BJdRwy9uXhTO' },
  { n: '05', title: 'Flowers',           artist: 'Miley Cyrus',         id: '4Dvkj6JhhA12EX05fT7y2e' },
  { n: '06', title: 'Calm Down',         artist: 'Rema & Selena Gomez', id: '0WtM2NBus2YxNiXK0X4bHW' },
  { n: '07', title: 'As It Was',         artist: 'Harry Styles',        id: '4LRPiXqCikLlN15c3yImP7' },
  { n: '08', title: 'Peaches',           artist: 'Justin Bieber',       id: '4iJyoBOLtHqaWYs3vyWFQE' },
  { n: '09', title: 'Woman',             artist: 'Doja Cat',            id: '6PCUP3dWmTjcTtXY02oFdT' },
  { n: '10', title: 'Bloody Samaritan',  artist: 'Ayra Starr',          id: '2plbrEY59IikOBgBGLjaoe' },
]
...
export default function Playlist() {
  ...
  return (
    <section style={{
      ...
      justifyContent: 'center',
      overflow: 'hidden',
      background: "url('/assets/leiss-3.jpeg') center 20% / cover no-repeat",
    }}>
      ...
      <div style={{
        position: 'absolute',
        inset: 0,
        background: 'linear-gradient(to bottom, #0a0a0a 0%, rgba(10,10,10,0.72) 20%, rgba(10,10,10,0.72) 80%, #0a0a0a 100%)',
        zIndex: 1,
      }} />
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 'var(--sp-12)' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-title)', fontWeight: 800, fontSize: 'clamp(2rem, 5vw, 3.5rem)', letterSpacing: '0.06em', color: '#fff', textTransform: 'uppercase', lineHeight: 1, marginBottom: 'var(--sp-3)' }}>Birthday Playlist</h2>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.85rem', color: 'var(--color-text-soft)' }}>Songs picked just for this day ✨</p>
        </div>

        {/* Desktop: 2-col grid */}
        {!isMobile && (
          <ul style={{ listStyle: 'none', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 var(--sp-16)' }}>
