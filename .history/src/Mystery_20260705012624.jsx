...
const activities = [
  ...
  },
  {
    ...
    body: 'Call that creazy dude. Not a voice note, not a text a real call. Two hours minimum. Talk about where you\'re both headed, what scares you, what excites you or even start a fight haha. The friendships that survive distance are the ones worth protecting. or follow him for rally 3pm at ',
  },
  {
    icon: '🍦',
